...
class MovieDetailContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MovieDetialsBloc, MovieDetialsState>(
      buildWhen: (previous, current) =>
          previous.detialsState != current.detialsState,
      builder: (context, state) {
        // ignore: avoid_print
        print('detial state: ${state.detialsState}');
        switch (state.detialsState) {
                      ...
                      child: ShaderMask(
                        ...
                        child: CachedNetworkImage(
                          ...
                          imageUrl: ApiConstance.imageUrl(
                              state.movieDetials!.backdropPath),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                child: Text(
                                  state.movieDetials!.releaseDate.split('-')[0],
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                    (state.movieDetials!.voteAverage / 2)
                                        .toStringAsFixed(1),
                                    style: const TextStyle(
                                      fontSize: 16.0,
                                      fontWeight: FontWeight.w500,
                                  ...
                                  const SizedBox(width: 4.0),
                                  Text(
                                    '(${state.movieDetials!.voteAverage})',
                                    style: const TextStyle(
                                      fontSize: 1.0,
                                      fontWeight: FontWeight.w500,
                                      letterSpacing: 1.2,
                              ...
                              const SizedBox(width: 16.0),
                              Text(
                                _showDuration(state.movieDetials!.runtime),
                                style: const TextStyle(
                          ...
                          const SizedBox(height: 8.0),
                          Text(
                            '${AppString.genres}: ${_showGenres(state.movieDetials!.genres)}',
                            style: const TextStyle(
                              color: Colors.white70,
                              fontSize: 12.0,
                              fontWeight: FontWeight.w500,
          ...
          case RequestState.error:
            return Center(child: Text(state.errorMovieDetialsMessage));
        }
      },
    );
  }
  ...
  Widget _showRecommendations() {
    return BlocBuilder<MovieDetialsBloc, MovieDetialsState>(
        ...
        builder: (context, state) {
          // ignore: avoid_print
          print('recommendation : ${state.recommendationsState}');
          return SliverGrid(
